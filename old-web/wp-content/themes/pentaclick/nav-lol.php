<section id="navbar" class="nav-lol">
    ...
    <nav class="globalnav">
        <ul>
            <li id="back-url"><a href="<?=qtrans_convertURL(get_site_url(), qtrans_getLanguage())?>" title="Pentaclick eSports">Pentaclick eSports<br /><small><?=_e('back', 'pentaclick')?></small></a></li>
            ...
            <li id="register-url"><a href="<?=qtrans_convertURL(LOLURL, qtrans_getLanguage())?>#register" <?=is_home()?'class="scroll"':null?> title="<?=_e('register', 'pentaclick')?>"><?=_e('register', 'pentaclick')?><br /><small><?=_e('register-sub', 'pentaclick')?></small></a></li>
            ...
            <li id="fame-url"><a href="<?=qtrans_convertURL(LOLURL, qtrans_getLanguage())?>#fame" <?=is_home()?'class="scroll"':null?> title="<?=_e('hall_of_fame', 'pentaclick')?>"><?=_e('hall_of_fame', 'pentaclick')?><br /><small><?=_e('fame-sub', 'pentaclick')?></small></a></li>
        </ul>
    </nav>
</section>