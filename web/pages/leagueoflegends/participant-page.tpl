        ...
        <div class="block-content">
            <?=str_replace(
                ...
                array(
                    ...
                    '<a href="http://events.'.$this->server.'.leagueoflegends.com/en/events/'.$this->eventId.'" target="_blank">http://events.'.$this->server.'.leagueoflegends.com/en/events/'.$this->eventId.'</a>'
                ),
