...
<div class="left-containers">
	...
	<div class="block">
        ...
        <div class="block-content vods">
            ...
            <p><?=t('brackets')?>: <a href="http://pentaclick.challonge.com/lol<?=$this->data->settings['lol-current-number']?>/" target="_blank">http://pentaclick.challonge.com/lol<?=$this->data->settings['lol-current-number']?>/</a></p>
