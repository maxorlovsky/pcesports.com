    ...
    <div class="block">
        ...
        <form class="block-content contact-form profile" name="form">
            ...
            <div class="fields">
                ...
                <input name="tag" id="tag" ng-model="tag" type="text" value="" placeholder="<?=t('team_tag')?>*" ng-minlength="2" ng-maxlength="5" ng-pattern="/^[A-Z0-9]+$/" ng-model-options="{ updateOn: 'keyup', debounce: 500 }" required />
            ...
            <div class="fields">
                ...
                <input name="password" id="password" ng-model="password" type="text" value="" placeholder="<?=t('team_password')?>*" ng-minlength="3" ng-model-options="{ updateOn: 'keyup', debounce: 500 }" required />
