<section id="navbar">
    ...
    <nav class="globalnav">
        <ul>
            ...
            <li class="external"><a href="<?=qtrans_convertURL(LOLURL, qtrans_getLanguage())?>" title="<?=_e('lol', 'pentaclick')?>"><?=_e('lol', 'pentaclick')?><br /><small><?=_e('next-tourn-nr', 'pentaclick')?> #<?=cOptions('tournament-lol-number')?></small></a></li>
            <li class="external"><a href="<?=qtrans_convertURL(HSURL, qtrans_getLanguage())?>" title="<?=_e('hearthstone', 'pentaclick')?>"><?=_e('hearthstone', 'pentaclick')?><br /><small><?=_e('next-tourn-nr', 'pentaclick')?> #<?=cOptions('tournament-hs-number')?></small></a></li>
        </ul>
    </nav>
</section>