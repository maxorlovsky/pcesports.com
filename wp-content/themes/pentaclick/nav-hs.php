<section id="navbar">
    ...
    <nav class="globalnav">
        <ul>
            ...
            <li id="participants-url"><a href="<?=qtrans_convertURL(get_site_url(), qtrans_getLanguage())?>#participants" <?=is_home()?'class="scroll"':null?> title="<?=_e('participants', 'pentaclick')?>"><?=_e('participants', 'pentaclick')?><br /><small><?=_e('participant-sub', 'pentaclick')?></small></a></li>
            <li id="register-url"><a href="<?=qtrans_convertURL(get_site_url(), qtrans_getLanguage())?>#register" <?=is_home()?'class="scroll"':null?> title="<?=_e('register', 'pentaclick')?>"><?=_e('register', 'pentaclick')?><br /><small><?=_e('register2-sub', 'pentaclick')?></small></a></li>
