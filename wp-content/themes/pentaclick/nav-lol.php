<section id="navbar" class="nav-lol">
    ...
    <nav class="globalnav">
        <ul>
            ...
            <li id="fame-url"><a href="<?=qtrans_convertURL(get_site_url(), qtrans_getLanguage())?>#fame" <?=is_home()?'class="scroll"':null?> title="<?=_e('hall_of_fame', 'pentaclick')?>"><?=_e('hall_of_fame', 'pentaclick')?><br /><small><?=_e('fame-sub', 'pentaclick')?></small></a></li>
        </ul>
    </nav>
</section>